...
export const lightThemeOverrides: GlobalThemeOverrides = {
  common: {
    primaryColor: '#d91920',
    primaryColorHover: '#b8151b',
    primaryColorPressed: '#9a1116',
    primaryColorSuppl: '#d91920',
    bodyColor: '#fafafa',
    cardColor: '#ffffff',
    modalColor: '#ffffff',
    popoverColor: '#ffffff',
  ...
  Button: {
    ...
    colorPrimary: '#d91920',
    colorHoverPrimary: '#b8151b',
    colorPressedPrimary: '#9a1116',
  },
  Input: {
    color: '#ffffff',
    colorFocus: '#ffffff',
...
export const darkThemeOverrides: GlobalThemeOverrides = {
  common: {
    primaryColor: '#e8555a',
    primaryColorHover: '#f07b7f',
    primaryColorPressed: '#ff9aa0',
    primaryColorSuppl: '#e8555a',
    bodyColor: '#1a1a1a',
    cardColor: '#2a2a2a',
    modalColor: '#2a2a2a',
    popoverColor: '#2a2a2a',
  ...
  Button: {
    textColorPrimary: '#ffffff',
    colorPrimary: '#e8555a',
    colorHoverPrimary: '#f07b7f',
    colorPressedPrimary: '#ff9aa0',
  },
  Input: {
    color: '#2a2a2a',
    colorFocus: '#2a2a2a',
