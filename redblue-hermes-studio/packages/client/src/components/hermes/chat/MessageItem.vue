...
function presentationText(value: string, compactUserPrompt = false): string {
  let text = String(value || '')
  if (compactUserPrompt) {
...
const displayText = computed(() => {
  if (!isContentBlockArray.value) {
    return presentationText(props.message.content || '', props.message.role === 'user');
  }

  // Extract text from blocks
  return presentationText(contentBlocks.value!
...
const thinkingFullText = computed(() => {
  ...
  return presentationText(parts.join("\n\n"));
});

const displayedAssistantBody = computed(() => presentationText(parsedThinking.value.body))
const displayedAssistantContent = computed(() => presentationText(props.message.content || ''))
        ...
        <div class="msg-content" :class="message.role">
          ...
          >
            ...
            <MarkdownRenderer
              ...
              :content="displayedAssistantBody"
