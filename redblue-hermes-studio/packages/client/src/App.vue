...
const usesPageSidebar = computed(() =>
  ['hermes.chat', 'hermes.session', 'hermes.connections', 'hermes.history', 'hermes.historySession', 'hermes.globalAgent', 'hermes.globalAgentSession', 'hermes.groupChat', 'hermes.groupChatRoom', 'hermes.workflow', 'hermes.cyberDefense'].includes(route.name as string),
)
