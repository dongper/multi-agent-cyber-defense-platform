...
import { cyberDefenseZhTw } from '../cyber-defense'

export default {
  socialMessages: socialMessagesZhTw,
  cyberDefense: cyberDefenseZhTw,
  browser: {
    title: '瀏覽器', settings: '瀏覽器設定', desktopOnly: '內建瀏覽器僅在 联通智能体 桌面版可用。', newTab: '新分頁',
  ...
  runtimeVersions: {
    ...
    cliUpdateDescription: 'Hermes Runtime 0.19.1 及以上版本支援透過以下指令單獨升級內建的 Hermes Agent；此指令不會升級 联通智能体 桌面端或 Web UI。執行前請先完全結束 联通智能体：',
    webUiTitle: 'Web UI',
    platform: '平台',
    ...
    runtimeDirectorySaved: 'Runtime 遷移已排程，重新啟動 联通智能体 後執行。',
    runtimeMigrationPending: '待遷移至：{directory}',
    runtimeMigrationFailed: '儲存目錄遷移失敗，已繼續使用原目錄',
    runtimeActivationFailed: '所選 Runtime 無法啟動，联通智能体 已改用其他已安裝版本',
    active: '已啟用',
    installed: '已安裝',
    download: '下載',
    ...
    activateSuccess: '版本選擇已儲存，重啟 联通智能体 後生效。',
    jobStatus: {
      queued: '排隊中',
      running: '下載中',
      completed: '已完成',
  ...
  chat: {
    ...
    pushEnabled: '是否推送',
    pushNotConfigured: '請先到 联通智能体「裝置互聯」中設定訊息推送。',
  ...
  settings: {
    ...
    display: {
      ...
      notifyOnApprovalHint: '联通智能体 不在前景時，新的審批或澄清會傳送系統通知；通知不顯示敏感詳情',
      ...
      approvalNotificationBody: '開啟 联通智能体 查看並處理。',
    ...
    voice: {
      ...
      hermesConfigDescription: 'Hermes profile 中原有的原生提供商會繼續保留；Web UI 管理的提供商對 Hermes 統一顯示為 联通智能体。',
